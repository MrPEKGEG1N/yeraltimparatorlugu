...
(function (global) {
  ...
  function getHTML() {
    return ''
      ...
      + '<button type="button" class="ml-menu-btn mafia-cell" id="guclenMenuBtn" onclick="ekranDegistir(\'guclen\')"><span class="ml-menu-emoji" aria-hidden="true">💪</span><span class="ml-menu-label">Güçlen/Silahlan</span></button>'
      + '<button type="button" class="ml-menu-btn mafia-cell" id="sporSalonuMenuBtn" onclick="ekranDegistir(\'sporSalonu\')"><span class="ml-menu-emoji" aria-hidden="true">🏋️</span><span class="ml-menu-label">Spor Salonu</span></button>'
      + '<button type="button" class="ml-menu-btn mafia-cell" id="buyumeMenuBtn" onclick="ekranDegistir(\'buyume\')"><span class="ml-menu-emoji" aria-hidden="true">⭐</span><span class="ml-menu-label">İcraat İşleri</span></button>'
